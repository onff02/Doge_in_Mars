...
const s = StyleSheet.create({
  ...
  backText: { color: "#fbbf24", fontWeight: "800", fontSize: 12 },
  headerTitle: { color: "#f59e0b", fontWeight: "900", fontSize: 18, letterSpacing: 0.6 },
  ...
  cardTitle: { color: "#fbbf24", fontWeight: "900", fontSize: 14, letterSpacing: 0.4 },
  ...
  statLabel: { color: "rgba(251,191,36,0.7)", fontSize: 9, fontWeight: "700" },
  statValue: { color: "rgba(251,191,36,0.85)", fontSize: 9, fontWeight: "800" },
  statTrack: { height: 6, borderRadius: 999, overflow: "hidden", backgroundColor: "rgba(69, 10, 10, 0.6)" },
  statFill: { height: 6, borderRadius: 999, backgroundColor: "#f59e0b" },
  ...
  confirmText: { color: "#ffffff", fontWeight: "900", letterSpacing: 0.8, fontSize: 13, textAlign: "center" },
  confirmGlow: {
